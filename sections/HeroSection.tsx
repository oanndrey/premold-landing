...
export default function HeroSection() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <motion.a href="#!" className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-red-100 bg-red-200/15"
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>O ERP completo para sua fábrica</span>
...
>
    Eficiência real para sua fábrica de{" "}
    <span className="bg-gradient-to-r from-red-600 via-red-400 to-red-800 bg-clip-text text-transparent px-3 rounded-xl text-nowrap animate-gradient">
        Premoldados.
    </span>
</motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Controle total de blocos, pisos e artefatos de cimento. Automatize sua produção e aumente a lucratividade da sua equipe.
            </motion.p>
            ...
            >
                ...
                <button className="flex items-center gap-2 border border-red-900 hover:bg-red-950/50 transition rounded-full px-6 h-11">
